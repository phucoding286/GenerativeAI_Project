from memories_manager_modules.__activateLocalMemories import ActivateLocalMemories
from memories_manager_modules.__shortContextManager import ShortContextManager
from memories_manager_modules.__writeNewLocalMem import WriteNewLocalMemories
import os
